...
public class Billing implements Serializable {
    ...
    public Billing(String billId, String patientId, Date billDate) {
        ...
        this.paymentStatus = "НЕОПЛАЧЕННЫЙ";
    ...
    public void setTotalAmount(double totalAmount) {
        if (totalAmount < 0) {
            throw new IllegalArgumentException("Общая сумма не может быть отрицательной");
        }
        this.totalAmount = totalAmount;
    }
    ...
    public void setTax(double tax) {
        if (tax < 0) {
            throw new IllegalArgumentException("Налог не может быть отрицательным");
        }
        this.tax = tax;
        calculateTotal();
    }
    ...
    public String toString() {
        return "Идентификатор счета: " + billId + ", Идентификатор пациента: " + patientId +
                ", Дата: " + billDate + ", Сумма: " + totalAmount +
