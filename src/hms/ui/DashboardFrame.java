...
public class DashboardFrame extends JFrame {
    ...
    private void initializeUI() {
        setTitle("Медицинская информационная система - Панель управления");
        setSize(1200, 700);
    ...
    private JPanel createHeaderPanel() {
        ...
        try {
            ...
            System.out.println("Лого не найдено: " + e.getMessage());
        }
        ...
        JLabel userLabel = new JLabel("Добро пожаловать, " + currentUser.getFullName() + " (" + currentUser.getRole() + ")");
    ...
    private JPanel createMenuPanel() {
        ...
        medicineButton = createMenuButton("Аптека", "icons/medicine.png");
        billingButton = createMenuButton("Счет", "icons/billing.png");
        reportsButton = createMenuButton("Отчеты", "icons/report.png");
    ...
    private JPanel createFooterPanel() {
        ...
        JLabel footerLabel = new JLabel("© 2025 Око | Все права защищены");
    ...
    private void showWelcomePanel() {
        ...
        JLabel welcomeLabel = new JLabel("Добро пожаловать в систему управления клиникой");
        ...
        statsPanel.add(createStatCard("Лекарства", "423", new Color(220, 20, 60)));
        statsPanel.add(createStatCard("Неоплаченные счета", "18", new Color(148, 0, 211)));
        statsPanel.add(createStatCard("Пользователи", "12", new Color(30, 144, 255)));
